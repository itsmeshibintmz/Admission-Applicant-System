...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item"><a class="nav-link" href="./fetch.jsp">Retrieve
						Application</a></li>
			</ul>
		</div>
</nav>
	...
	<div class="longbox">
		<form class="row g-3 insidebox" name="form" action="./application"
			method="post">
			...
			<div class="col-md-4">
				<label for="inputState" class="form-label">Select Your
					Course</label> <select name="course" id="inputState" class="form-select"
					required>
					<option value=""></option>
			...
			<div class="col-12">
				<button type="submit" name="s1" class="btn btn-primary">Save
					& Next</button>
			</div>
